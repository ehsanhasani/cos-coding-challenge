...
export class AuctionMonitorApp {
  public constructor(
    ...
    @inject(DependencyIdentifier.CALCULATE_CAR_ON_SALE_JSON)
    private calculateClientJson: ICarOnSaleCalculation
  ) {}
  ...
  public async start(): Promise<void> {
    ...
    const collection = await this.carOnSaleClient.getRunningAuctions(
      this.authentication
    );
